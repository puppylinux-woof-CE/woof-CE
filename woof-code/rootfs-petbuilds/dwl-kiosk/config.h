...
static const Key keys[] = {
	...
	{ 0,                         XXKB_KEY_XF86MonBrightnessUp,       spawn,          {.v = brightnessupcmd} },
	{ 0,                         XXKB_KEY_XF86MonBrightnessDown,     spawn,          {.v = brightnessdowncmd} },
	{ 0,                         XXKB_KEY_XF86AudioRaiseVolume,      spawn,          {.v = volumeupcmd} },
